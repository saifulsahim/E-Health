...
<section id="cta-3">
    ...
    <div class="container">
        <h3 class="text-center">Cardiology Specialist</h3>
    ...
    <div class="container">
        ...
        <h3 class="text-center">Neurology Specialist</h3>
    ...
    <div class="container">
        <h3 class="text-center">Nephrology Specialist</h3>
    ...
    <div class="container">
        <h3 class="text-center">Orthopedics Specialist</h3>
        <table width="100%" class="table table-striped table-bordered table-hover dataTables-example">
            <thead>
            <tr>
                <th scope="col">Serial No</th>
