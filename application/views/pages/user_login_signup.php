                        ...
                        <div class="panel-body" class="content">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <form id="register-form" action="<?php echo base_url('blog/save_user') ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="adminName" id="username" tabindex="1"
                                                   class="form-control" placeholder="User Name" value="">
                                        </div>

                                        <div class="form-group">

                                            <input type="email" name="adminEmail" id="email" tabindex="1"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="userImage" id="email" tabindex="1"
