                        ...
                        <div class="panel-body" class="content">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <form id="login-form" action="<?php echo base_url('doctor/doc_login_check')?>" method="post" role="form" style="display: block;">
                                        <div class="panel-heading">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="docEmail" id="username" tabindex="1"
                                    ...
                                    <form id="register-form" action="<?php echo base_url('welcome/save_doctor')?>" method="post" role="form"
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="docQual"  class="form-control" placeholder="Enter Qualification">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <input  type="text" name="docJoinDate" placeholder="Enter Joining Date"  class="form-control datepicker">
                                        </div>
