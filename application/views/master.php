                ...
                <div class="col-md-12">
                    ...
                    <div class="collapse navbar-collapse navbar-right" id="myNavbar">
                        <ul class="nav navbar-nav">
                            ...
                            <li class=""><a href="http://localhost/Shop/E-commerce/" target="_blank">Shop</a></li>
                            <li class=""><a href="#contact">Contact</a></li>
                            <li class=""><a href="blood.html">Blood</a></li>
                            <li class=""><a href="ambulance.html">Ambulance</a></li>
                            <li class=""><a href="login.html">Login/signin</a></li>
                        </ul>
                        </ul>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <div class="thumbnail">
                    <img src="asset/img/doctor1.jpg" alt="..." class="team-img">
                    <div class="caption">
                        <h3>Jessica Wally</h3>
                        <p>Doctor</p>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <div class="thumbnail">
                    <img src="asset/img/doctor2.jpg" alt="..." class="team-img">
                    <div class="caption">
                        <h3>Iai Donas</h3>
                        <p>Doctor</p>
                        <ul class="list-inline">
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <div class="thumbnail">
                    <img src="asset/img/doctor3.jpg" alt="..." class="team-img">
                    <div class="caption">
                        <h3>Amanda Denyl</h3>
                        <p>Doctor</p>
                        <ul class="list-inline">
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <div class="thumbnail">
                    <img src="asset/img/doctor4.jpg" alt="..." class="team-img">
                    <div class="caption">
                        <h3>Jason Davis</h3>
                        <p>Doctor</p>
                        <ul class="list-inline">
                ...
                <div class="contact-info">
                    ...
                    <form action="" method="post" role="form" class="contactForm">
                        <div class="form-group">
                            <input type="text" name="name" class="form-control br-radius-zero" id="name" placeholder="Enter Doctors name " data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
